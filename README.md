...
### Status
The base requirements were delivered, and some small features were added: handling of bad records, highlighting late events, etc. The main focus was on quality and simplicity.
